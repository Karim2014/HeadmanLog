...
public class TextViewFontSupport extends android.support.v7.widget.AppCompatTextView {

    public TextViewFontSupport(Context context) {
        super(context);
    }

    public TextViewFontSupport(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public TextViewFontSupport(Context context, AttributeSet attrs, int defStyleAttr) {
